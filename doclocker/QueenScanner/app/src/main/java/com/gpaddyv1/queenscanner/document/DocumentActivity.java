...
import com.gpaddyv1.queenscanner.handle.HandleActivity;
...
public class DocumentActivity extends BaseActivity implements com.gpaddyv1.queenscanner.document.DocumentContract.DocumentView, OnLongClickItem, OnChangeDynamic {
    private com.gpaddyv1.queenscanner.document.DocumentContract.IDocumentPresenter presenter;
    private com.gpaddyv1.queenscanner.document.DocumentAdapter adapter;
   ...
   // private AdsTask adsTask;
    ...
    protected void initView() {
        ...
        presenter = new com.gpaddyv1.queenscanner.document.DocumentPresenter(this, this);
        rcView.setLayoutManager(new GridLayoutManager(this, 2));
        adapter = new com.gpaddyv1.queenscanner.document.DocumentAdapter(this, presenter);
    ...
    class SaveData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            for (int i = 0; i < arrModel.size(); i++) {
                com.gpaddyv1.queenscanner.document.DocumentModel documentModel = (com.gpaddyv1.queenscanner.document.DocumentModel) arrModel.get(i);
...
//                        break;
                    case R.id.menuSaveToPDF:
                        ...
                        for (Object o : arrModel) {
                            com.gpaddyv1.queenscanner.document.DocumentModel documentModel = (com.gpaddyv1.queenscanner.document.DocumentModel) o;
